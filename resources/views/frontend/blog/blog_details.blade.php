...
<div class="page-header breadcrumb-wrap">
    <div class="container">
       <div class="breadcrumb">
          ...
          @if(session()->get('language') == 'bangla') 
          {{ $blogdetails->post_title_bn }}      
          @else 
          {{ $blogdetails->post_title_en }}                      
          @endif
       </div>
    </div>
 </div>
                         ...
                         <div class="row">
                            <div class="col-xl-10 col-lg-12 m-auto">
                               <p class="single-excerpt"> 
                                  @if(session()->get('language') == 'bangla') 
                                  {!! $blogdetails->post_long_description_bn !!} 
                                  @else 
                                  {!! $blogdetails->post_long_description_en !!} 
                   ...
                   <div class="widget-area">
                      ...
                      <div class="sidebar-widget widget-category-2 mb-50">
                         ...
                         <ul>
                            ...
                            @endphp
                            <li>
                               <a href="{{ url('post/category/'.$category->id.'/'.$category->blog_category_slug) }}""> <img src="{{ asset('frontend/assets/imgs/theme/icons/category-1.svg') }}" alt="" />
                            @if(session()->get('language') == 'bangla') 
                             {{ $category->blog_category_name_bn }}
                             @else 
                             {{ $category->blog_category_name_en }}
                             @endif
                               </a><span class="count">{{ count($posts) }}</span>
                            </li>
                            @endforeach
                         </ul>
                      </div>
