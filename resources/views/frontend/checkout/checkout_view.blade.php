...
<form method="post" action="{{ route('checkout.store') }}">
    ...
    <div class="row">
        <div class="form-group col-lg-6">
            <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Name</label>
            <input type="text" required="" name="shipping_name" value="{{ Auth::user()->name }}" >
        </div>
        <div class="form-group col-lg-6">
            <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Email</label>
    ...
    <div class="row shipping_calculator">
	    <div class="form-group col-lg-6">
	        <div class="custom_select">
                <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Division Select</label>
        ...
        <div class="form-group col-lg-6">
            <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Phone No</label>
      <input required="" type="text" name="shipping_phone" value="{{ Auth::user()->phone }}">
                    ...
                    <div class="row shipping_calculator">
                        <div class="form-group col-lg-6">
                            <div class="custom_select">
                                <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> District Select</label>
                        ...
                        <div class="form-group col-lg-6">
                            <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Post Code</label>
...
<div class="row shipping_calculator">
    <div class="form-group col-lg-6">
        <div class="custom_select">
            <label for="#" class="fw-bold text-black"><span class="text-danger">*</span>Upazila</label>
            <select name="state_id" class="form-control">
                <option value="">Select Upazila...</option>
                        ...
                        <div class="form-group col-lg-6">
                            <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Address</label>
                    ...
                    <div class="form-group mb-30">
                        <label for="#" class="fw-bold text-black"><span class="text-danger">*</span> Comment</label>
