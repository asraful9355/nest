         ...
         <div class="row align-items-center">
            <div class="col-xl-3">
               ...
               <div class="breadcrumb">
                  ...
                  <span></span>
                  @if(session()->get('language') == 'bangla') 
                  {{ $breadsubcat->category->category_name_bn }}
                  @else 
                  {{ $breadsubcat->category->category_name_en }}
                  @endif
                  <span></span>  
                  @if(session()->get('language') == 'bangla') 
                  {{ $breadsubcat->subcategory_name_bn }} 
                  @else 
                  {{ $breadsubcat->subcategory_name_en }}
                  @endif
               </div>
            </div>
         </div>
      ...
      <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
         <div class="sidebar-widget widget-category-2 mb-30">
            ...
            <ul>
               ...
               @endphp
               <li>
                  <a href="{{ url('product/category/'.$category->id.'/'.$category->slug) }}"> <img src=" {{ asset($category->category_image) }} " alt="" />
                    @if(session()->get('language') == 'bangla') 
