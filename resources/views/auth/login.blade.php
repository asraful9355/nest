...
<head>
    @include('frontend.home.css_link')
</head>
...
#iconHidden {
  position: relative;
  left: -25px; /* Position the icons relative to the password field */
  cursor: pointer;
...
<body>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="Post" action="{{ route('login') }}"> 
                                            ...
                                            <div  class="form-group">
                                                <input required="" type="password"   id="passwordField" oninput="checkPasswordVisibility()" name="password" placeholder="Your password *"/>
                                               <span style="position:relative; left:95%; font-size:large; bottom:44px;">
                                                <i  class="far fa-eye" id="iconVisible" onclick="togglePasswordVisibility()"></i>
                                                <i id="iconHidden" class="far fa-eye-slash" onclick="togglePasswordVisibility()"></i>
                                               </span>
  ...
  var iconHidden = document.getElementById("iconHidden");
