      ...
      <div class="main-body">
         <div class="row">
            <div class="col-lg-10">
               <div class="card">
                  <div class="card-body">
                     <form id="myForm" method="post" action="{{ route('update.blog.category',$blogcategory->id) }}" enctype="multipart/form-data" >
                        @csrf
                      
                        <div class="row mb-3">
                           <div class="col-sm-3">
                              <h6 class="mb-0">Blog Category Name En</h6>
                           </div>
                        ...
                        <div class="row mb-3">
                           <div class="col-sm-3">
                              <h6 class="mb-0">Blog Category Name Bn</h6>
                           </div>
                           <div class="form-group col-sm-9 text-secondary">
