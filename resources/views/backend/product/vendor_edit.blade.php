...
<div class="page-content">
   ...
   <div class="card">
      <div class="card-body p-4">
         ...
         <hr/>
         <form id="myForm" method="post" action="{{ route('vendor.product.update',$products->id) }}"  >
			@csrf
                  ...
                  <div class="col-lg-8">
                     <div class="border border-3 p-4 rounded">
                        <div class="form-group mb-3">
                           ...
                           <input type="text" name="product_name_en" class="form-control" id="inputProductTitle" value="{{ $products->product_name_en }}">
                        </div>
                        <div class="form-group mb-3">
                           <label for="inputProductTitle" class="form-label">Product Name</label>
                           <input type="text" name="product_name_bn" class="form-control" id="inputProductTitle" value="{{ $products->product_name_bn }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="form-group mb-3">
                           ...
                           <textarea name="short_descp_en" class="form-control" id="inputProductDescription" rows="3">
                           {{ $products->short_descp_en }}
                           </textarea>
                        </div>
                        <div class="form-group mb-3">
                           <label for="inputProductDescription" class="form-label">Short Description</label>
                           <textarea name="short_descp_bn" class="form-control" id="inputProductDescription" rows="3">
                           {{ $products->short_descp_bn }}
                           </textarea>
                        </div>
                        <div class="mb-3">
                           <label for="inputProductDescription" class="form-label">Long Description</label>
                           <textarea class="mytextarea" name="long_descp_en">
                           {!! $products->long_descp_en !!}</textarea>
                        </div>
                        <div class="mb-3">
                           <label for="inputProductDescription" class="form-label">Long Description</label>
                           <textarea class="mytextarea" name="long_descp_bn">
                           {!! $products->long_descp_bn !!}</textarea>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4">
...
<div class="page-content">
   ...
   <hr>
<div class="card">
   <form  method="post" action="{{ route('vendor.product.update.thambnail',$products->id) }}"  enctype="multipart/form-data">
      @csrf
   <div class="card-body">
      <div class="mb-3">
      ...
      <div class="mb-3">
         ...
         <img src="{{ asset($products->product_thambnail) }}" style="width:100px;height:100px" id="showImage">
      </div>
...
@csrf
	...
	<tr>
		...
		<td> <img src="{{ asset($img->photo_name) }}" style="width:70; height: 40px;" id="show"> </td>
		<td> <input type="file" class="form-group" name="multi_img[{{ $img->id }}]" id="img"> </td>
		<td> 
