...
<div class="page-content">
   ...
   <div class="card">
      <div class="card-body p-4">
         ...
         <hr/>
         <form id="myForm" method="post" action="{{ route('product.update',$products->id) }}"  >
			@csrf
...
<div class="page-content">
   ...
   <hr>
<div class="card">
   <form  method="post" action="{{ route('product.update.thambnail',$products->id) }}"  enctype="multipart/form-data">
      @csrf
   <div class="card-body">
      <div class="mb-3">
